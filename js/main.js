...
;(function(window) {
	...
	var bodyEl = document.body, 
		...
		scrollContainer = document.querySelector('.wrapper'),
		...
		navRightCtrl = sliderEl.querySelector('.btn_nav-next'),
		navLeftCtrl = sliderEl.querySelector('.btn_nav-prev'),
		zoomCtrl = sliderEl.querySelector('.btn_zoom'),
		// the main content element
		contentEl = document.querySelector('.content'),
		// close content control
		closeContentCtrl = contentEl.querySelector('button.btn_close'),
	...
	function openItem(item) {
		...
		onEndTransition(zoomer, function() {
			...
			classie.add(contentEl, 'content_open');
	...
	function closeContent() {
		...
		classie.remove(contentEl, 'content_open');
